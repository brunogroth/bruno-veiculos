        ...
        <form action="{{route('veiculo.update', $veiculo->id)}}" method="POST">
            ...
            <div class="row col-12 col-md-10 col-lg-7 col-xl-6">
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="placa" name="placa" class="form-control plate" value="{{$veiculo->placa}}" maxlength="7">
                    @if($errors->has('placa'))
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="marca" name="marca" class="form-control" value="{{$veiculo->marca}}" required>
                    @if($errors->has('marca'))
                    <div class="alert alert-danger p-2">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="modelo" name="modelo" class="form-control" value="{{$veiculo->modelo}}" required>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="valor_venda" class="form-control money" value="{{$veiculo->valor_venda}}" required>
